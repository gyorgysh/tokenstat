...
pub use profile::{
    ...
    LoginResult, PairingCode, ProfileError, ScheduledOutcome, SchedulingInfo, StatusResult,
    SyncOptions, SyncResult, TunnelToken, apple_activate, apple_renewal, cli_sync_schedule_active,
    device_poll, device_start, device_start_kind, fetch_account_limits, google_activate,
    jitter_offset, login, login_with_code, logout, mint_pairing_code, mint_tunnel_token,
    post_limits, publish_machine_profile, register_machine_identity,
...
pub use update::{
    ...
    UpdateOutcome, apply_update, apply_update_to, auto_apply_enabled, check_latest, current_target,
    download_app_image, download_windows_app_archive, has_macos_signing_authority,
    is_windows_app_zip, maybe_auto_update, scheduled_update, scheduled_update_to, version_cmp,
    windows_app_arch,
};
